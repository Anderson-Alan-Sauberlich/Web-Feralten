...
namespace application\view\src\layout\menu;
    ...
    class Usuario {
        ...
        function __construct(int $status, array $url) {
        	...
        	require_once RAIZ.'/application/view/html/layout/menu/Usuario.php';
        }
        ...
        public static function Incluir_Mensagem_Status_Usuario() : void {
        	if (self::$status_usuario !== null) {
	        	if (self::$status_usuario === 0 
	        		...
	        		include_once RAIZ.'/application/view/html/layout/mensagens/Cadastro_Incompleto.php';
	        	} else if (self::$status_usuario === 1) {
	        
	        	} else if (self::$status_usuario === 2) {
	        		include_once RAIZ.'/application/view/html/layout/mensagens/Pagamento_Atrasado.php';
	        	} else if (self::$status_usuario === 3) {
	        		include_once RAIZ.'/application/view/html/layout/mensagens/Conta_Desativada.php';
	        	}
        	}
        }
