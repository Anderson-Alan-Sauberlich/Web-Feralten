...
namespace application\view\src\include_page;
	...
	class Menu_Paginacao {
		...
		public static function Mostrar_Indices_Paginas() {
			...
			for ($i = $inicio; $i <= $fim; $i++) {
				if (self::$pagina == $i) {
					...
					echo "<a class=\"item\" href=\"/usuario/meu-perfil/auto-pecas/visualizar/?p=$i\">$i</a>";
				}
			}
		}
		...
		public static function Mostrar_Item_Anterior() {
			if (self::$pagina != 1) {
				echo "<a class=\"item\" href=\"/usuario/meu-perfil/auto-pecas/visualizar/?p=".(self::$pagina - 1)."\"><i class=\"chevron left icon\"></i></a>";
			} else {
		...
		public static function Mostrar_Item_Proximo() {
			if (self::$pagina != self::$paginas) {
				echo "<a class=\"item\" href=\"/usuario/meu-perfil/auto-pecas/visualizar/?p=".(self::$pagina + 1)."\"><i class=\"chevron right icon\"></i></a>";
			} else {
