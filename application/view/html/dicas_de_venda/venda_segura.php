<?php require_once RAIZ.'/application/view/src/dicas_de_venda/venda_segura.php'; ?>
<?php use application\view\src\dicas_de_venda\Venda_Segura as View_Venda_Segura; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
	<?php include_once RAIZ.'/application/view/html/include_page/head.php'; ?>
	<title>Venda Segura | Feralten</title>
</head>
<body>
    <header>
