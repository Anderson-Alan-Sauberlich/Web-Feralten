<?php require_once RAIZ.'/application/view/src/dicas_de_venda/apresentacao.php'; ?>
<?php use application\view\src\dicas_de_venda\Apresentacao as View_Apresentacao; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
	<?php include_once RAIZ.'/application/view/html/include_page/head.php'; ?>
	<title>Apresentação | Feralten</title>
</head>
<body>
    <header>
