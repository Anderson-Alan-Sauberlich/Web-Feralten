<?php require_once RAIZ.'/application/view/src/dicas_de_venda/principais.php'; ?>
<?php use application\view\src\dicas_de_venda\Principais as View_Principais; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
	<?php include_once RAIZ.'/application/view/html/include_page/head.php'; ?>
	<title>Principais | Feralten</title>
</head>
<body>
    <header>
