<?php require_once RAIZ.'/application/view/src/publicidade/porque_anunciar.php'; ?>
<?php use application\view\src\publicidade\Porque_Anunciar as View_Porque_Anunciar; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
	<?php include_once RAIZ.'/application/view/html/include_page/head.php'; ?>
	<title>Porque Anunciar | Feralten</title>
</head>
<body>
    <header>
