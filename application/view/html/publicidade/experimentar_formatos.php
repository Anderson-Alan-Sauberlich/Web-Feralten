<?php require_once RAIZ.'/application/view/src/publicidade/experimentar_formatos.php'; ?>
<?php use application\view\src\publicidade\Experimentar_Formatos as View_Experimentar_Formatos; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
	<?php include_once RAIZ.'/application/view/html/include_page/head.php'; ?>
	<title>Experimentar Formatos | Feralten</title>
</head>
<body>
    <header>
