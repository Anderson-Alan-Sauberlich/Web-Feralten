<?php require_once RAIZ.'/application/view/src/publicidade/condicoes_gerais.php'; ?>
<?php use application\view\src\publicidade\Condicoes_Gerais as View_Condicoes_Gerais; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
