<?php require_once RAIZ.'/application/view/src/publicidade/dicas.php'; ?>
<?php use application\view\src\publicidade\Dicas as View_Dicas; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
	<?php include_once RAIZ.'/application/view/html/include_page/head.php'; ?>
	<title>Dicas | Feralten</title>
</head>
<body>
    <header>
