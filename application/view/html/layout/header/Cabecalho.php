<?php use application\view\src\layout\header\Cabecalho as View_Cabecalho; ?>
<section class="margem-inferior-pouco">
<script type="text/javascript" src="/application/view/js/layout/header/cabecalho.js"></script>
