<?php require_once RAIZ.'/application/view/src/pecas/busca_programada.php'; ?>
<?php use application\view\src\pecas\Busca_Programada as View_Busca_Programada; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
	<?php include_once RAIZ.'/application/view/html/include_page/head/default.php'; ?>
	<title>Busca-Programada | Feralten</title>
</head>
<body>
    <header>
