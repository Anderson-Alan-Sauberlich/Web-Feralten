<?php require_once RAIZ.'/application/view/src/pecas/mais_visualizados.php'; ?>
<?php use application\view\src\pecas\Mais_Visualizados as View_Mais_Visualizados; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
	<?php include_once RAIZ.'/application/view/html/include_page/head/default.php'; ?>
	<title>Mais Visualizados | Feralten</title>
</head>
<body>
    <header>
