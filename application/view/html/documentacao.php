<?php require_once RAIZ.'/application/view/src/documentacao.php'; ?>
<?php use application\view\src\Documentacao as View_Documentacao; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
	<?php include_once RAIZ.'/application/view/html/include_page/head.php'; ?>
	<title>Documentação | Feralten</title>
</head>
<body>
    <header>
