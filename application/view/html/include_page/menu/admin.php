<?php require_once RAIZ.'/application/view/src/include_page/menu/admin.php'; ?>
<?php use application\view\src\include_page\menu\Admin as View_Admin; ?>
<script type="text/javascript" src="/application/view/js/include_page/menu/admin.js"></script>
<aside class="row">
