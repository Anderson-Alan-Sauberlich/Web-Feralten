<?php require_once RAIZ.'/application/view/src/include_page/menu/pesquisa.php'; ?>
<?php use application\view\src\include_page\menu\Pesquisa as View_Pesquisa; ?>
<script type="text/javascript" src="/application/view/js/include_page/menu/pesquisa.js"></script>
<section>
