<?php require_once RAIZ.'/application/view/src/include_page/menu/usuario.php'; ?>
<?php use application\view\src\include_page\menu\Usuario as View_Usuario; ?>
<script type="text/javascript" src="/application/view/js/include_page/menu/usuario.js"></script>
