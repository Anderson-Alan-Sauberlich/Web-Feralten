<?php require_once(RAIZ.'/application/view/src/usuario/meu_perfil/pacotes/meus_pacotes.php'); ?>
<?php use application\view\src\usuario\meu_perfil\pacotes\Meus_Pacotes; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
    <?php include_once(RAIZ.'/application/view/html/include_page/head.php'); ?>
	<title>Meus Pacotes | Feralten</title>
</head>
<body>
    <header>
