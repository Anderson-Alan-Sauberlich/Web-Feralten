<?php require_once(RAIZ.'/application/view/src/usuario/meu_perfil/pacotes/adicionar.php'); ?>
<?php use application\view\src\usuario\meu_perfil\pacotes\Adicionar; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
    <?php include_once(RAIZ.'/application/view/html/include_page/head.php'); ?>
	<title>Adicionar Pacote | Feralten</title>
</head>
<body>
    <header>
