<?php require_once RAIZ.'/application/view/src/usuario/meu_perfil/pecas/cadastrar.php'; ?>
<?php use application\view\src\usuario\meu_perfil\pecas\Cadastrar as View_Cadastrar; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
    <?php include_once RAIZ.'/application/view/html/include_page/head.php'; ?>
    <script type="text/javascript" src="/application/view/js/usuario/meu_perfil/pecas/cadastrar.js"></script>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="row">
		                        ...
		                        <div class="col-sm-3">
		                            ...
		                            <div class="input-group <?php View_Cadastrar::Incluir_Classe_Erros("status"); ?>">
		                                <span class="input-group-addon"><i class="glyphicon glyphicon-star-empty"></i></span>
		                                <select id="status" name="status" class="form-control form_select">
		                                    <option value="0">Selecione</option>
		                                    <?php View_Cadastrar::Mostrar_Status(); ?>
		                                </select>
