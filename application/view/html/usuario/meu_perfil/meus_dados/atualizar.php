                ...
                <div class="panel panel-default sombra_painel">
                    ...
                    <div class="panel-body dadosPanel">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group <?php self::Incluir_Classe_Erros("login", "nome"); ?>">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input id="nome" name="nome" type="text" class="form-control" value="<?php self::Manter_Valor("login", "nome") ?>" placeholder="Nome" data-toggle="popover" data-trigger="focus" data-placement="bottom" data-content="Digite seu nome Completo. (Campo Obrigatório)" />
                            </div>
                ...
                <div class="panel panel-default sombra_painel">
                    ...
                    <div class="panel-body dadosPanel">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group <?php self::Incluir_Classe_Erros("dadosusuario", "cpf_cnpj"); ?>">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-credit-card"></i></span>
                                <input id="cpf_cnpj" name="cpf_cnpj" type="text" class="form-control" value="<?php self::Manter_Valor("dadosusuario", "cpf_cnpj"); ?>" placeholder="CPF / CNPJ" data-toggle="popover" data-trigger="focus" data-placement="bottom" data-content="Digite apenas os Numeros do seu CPF ou CNPJ. (Campo Obrigatório)" />
                            </div>
                            <label for="nomedadosusuario" class="lbPanel">Digite um Nome Fantasia:</label>
                            <div class="input-group <?php self::Incluir_Classe_Erros("dadosusuario", "nomedadosusuario"); ?>">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-briefcase"></i></span>
                                <input id="nomedadosusuario" name="nomedadosusuario" type="text" class="form-control" value="<?php self::Manter_Valor("dadosusuario", "nomedadosusuario"); ?>" placeholder="Nome Fantasia" data-toggle="popover" data-trigger="focus" data-placement="bottom" data-content="Ao Informar um Nome neste campo o mesmo sera mostrado em seus dados, substituindo seu Nome de Usuario.  (Campo Obcional)" />
                            </div>
                            <label for="site" class="lbPanel">Digite o Endereço do seu Site:</label>
                            <div class="input-group <?php self::Incluir_Classe_Erros("dadosusuario", "site"); ?>">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-link"></i></span>
                                <input id="site" name="site" type="text" class="form-control" value="<?php self::Manter_Valor("dadosusuario", "site") ?>" placeholder="Digite o Endereço do seu site" data-toggle="popover" data-trigger="focus" data-placement="bottom" data-content="Informe aqui o Endereço do seu site, caso você tenha. (Campo Obcional)" />
                            </div>
	                        <div class="ui buttons linha_inteira btnAtualizar">
                    ...
                    <div class="panel-body dadosPanel">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group <?php self::Incluir_Classe_Erros("contato", "fone1"); ?>">
                                ...
                                <input id="fone1" name="fone1" type="text" class="form-control" value="<?php self::Manter_Valor("contato", "fone1") ?>" placeholder="Fone Ex: (00) 000-000" data-toggle="popover" data-trigger="focus" data-placement="bottom" data-content="Digite apenas os Numeros de seu telefone-1. (Campo Obrigatório)" />
                            </div>
                            <label for="fone2" class="lbPanel">Digite Seu Numero de Telefone-2:</label>
                            <div class="input-group <?php self::Incluir_Classe_Erros("contato", "fone2"); ?>">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-phone-alt"></i></span>
                                <input id="fone2" name="fone2" type="text" class="form-control" value="<?php self::Manter_Valor("contato", "fone2") ?>" placeholder="Fone Ex: (00) 000-000" data-toggle="popover" data-trigger="focus" data-placement="bottom" data-content="Digite apenas os Numeros de seu telefone-2. (Campo Obcional)" />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <label for="emailcontato" class="lbPanel">Digite Um E-Mail Alternativo:</label>
                            <div class="input-group <?php self::Incluir_Classe_Erros("contato", "emailcontato"); ?>">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                <input id="emailcontato" name="emailcontato" type="email" class="form-control" value="<?php self::Manter_Valor("contato", "emailcontato") ?>" placeholder="E-Mail Alternativo" data-toggle="popover" data-trigger="focus" data-placement="bottom" data-content="Ao Informar um Email neste campo o mesmo sera mostrado em seus dados, substituindo seu E-Mail de Usuario.  (Campo Obcional)" />
                            </div>
	                        <div class="ui buttons linha_inteira btnAtualizar">
