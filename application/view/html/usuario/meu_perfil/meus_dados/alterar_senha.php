...
<?php use application\view\src\usuario\meu_perfil\meus_dados\Alterar_Senha; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
...
<body>
    ...
    <section class="ui container" role="main">
        ...
        <?php Alterar_Senha::Mostrar_Erros(); ?>
        <form id="form_alterar_senha" name="form_alterar_senha" data-toggle="validator" action="/application/view/usuario/meu_perfil/meus_dados/alterar_senha.php" method="post" role="form">
                ...
                <div class="panel-body">
                	<div class="row">
	                    <div class="col-sm-offset-2 col-sm-8 col-md-offset-3 col-md-6">
	                        ...
	                        <div class="input-group <?php Alterar_Senha::Incluir_Classe_Erros("senha_antiga"); ?>">
	                            <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
	                            <input id="senha_antiga" name="senha_antiga" type="password" class="form-control" value="<?php Alterar_Senha::Manter_Valor("senha_antiga") ?>" placeholder="Senha Antiga" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="Informe a Senha Antiga Para Alterar Por Uma Nova. (Campo Obrigatório)" />
	                        ...
	                        <div class="input-group <?php Alterar_Senha::Incluir_Classe_Erros("senha_nova"); ?>">
	                            <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
	                            <input id="senha_nova" name="senha_nova" type="password" class="form-control" value="<?php Alterar_Senha::Manter_Valor("senha_nova") ?>" placeholder="Nova Senha" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="A Senha deve ter no minimo 8 caracteres e no maximo 20. (Campo Obrigatório)" />
								<span class="input-group-addon">
			                        <div class="ui checkbox passCheck">
	                        ...
	                        <div class="input-group <?php Alterar_Senha::Incluir_Classe_Erros("confsenha_nova"); ?>">
	                            <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
	                            <input id="confsenha_nova" name="confsenha_nova" type="password" class="form-control" value="<?php Alterar_Senha::Manter_Valor("confsenha_nova") ?>" placeholder="Confirmar Nova Senha" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="Digite a Senha novamente da mesma forma para Confirmila. (Campo Obrigatório)" />
								<span class="input-group-addon">
									<div class="ui checkbox passCheck">
