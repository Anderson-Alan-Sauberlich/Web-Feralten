<?php require_once(RAIZ.'/application/view/src/usuario/meu_perfil/auto_pecas/excluir.php'); ?>
<?php use application\view\src\usuario\meu_perfil\auto_pecas\Excluir; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
    <?php include_once(RAIZ.'/application/view/html/include_page/head.php'); ?>
	<title>Excluir | Feralten</title>
</head>
<body>
    <header>
