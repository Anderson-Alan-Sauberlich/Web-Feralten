<?php require_once RAIZ.'/application/view/src/admin/controle/base_de_conhecimento/cmmv/atualizar.php'; ?>
<?php use application\view\src\admin\controle\base_de_conhecimento\cmmv\Atualizar as View_Atualizar; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
