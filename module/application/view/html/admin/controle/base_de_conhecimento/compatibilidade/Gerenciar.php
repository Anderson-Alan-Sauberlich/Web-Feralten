<?php use module\application\view\src\admin\controle\base_de_conhecimento\compatibilidade\Gerenciar as View_Gerenciar; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
	<?php include_once RAIZ.'/module/application/view/html/layout/head/Admin.php'; ?>
	<title>Gerenciar-Compatibilidade | Feralten</title>
</head>
<body>
    <header>
        <?php include_once RAIZ.'/module/application/view/html/layout/header/Admin.php'; ?>    
    </header>
    ...
    <footer>
        <?php //include_once RAIZ.'/module/application/view/html/layout/Rodape.php'; ?>
