<?php
namespace module\application\view\src\admin\controle\base_de_conhecimento\cmmv;
    
    use module\application\controller\admin\controle\base_de_conhecimento\cmmv\Gerenciar as Controller_Gerenciar;
    ...
    class Gerenciar {
        ...
        public function Executar() : void {
            require_once RAIZ.'/module/application/view/html/admin/controle/base_de_conhecimento/cmmv/Gerenciar.php';
        }
