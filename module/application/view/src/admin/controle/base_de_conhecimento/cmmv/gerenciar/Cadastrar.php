<?php
namespace module\application\view\src\admin\controle\base_de_conhecimento\cmmv\gerenciar;
	...
	class Cadastrar {
		...
		public function Executar() : void {
			require_once RAIZ.'/module/application/view/html/admin/controle/base_de_conhecimento/cmmv/gerenciar/Cadastrar.php';
		}
