    	...
    	<div class="ui container">
        	<div class="header item">
           	...
           	<div id="header_esquerda" class="left menu">
                ...
                <div class="ui vertical inverted hidden menu comprar popup">
                ...
                <div class="ui vertical inverted hidden menu vender popup">
           	...
           	<div id="header_direita" class="right menu">
           		<?php if (View_Cabecalho::VerificaAutenticacao()) { ?>
                    <div id="drop_meu_feralten" class="ui pointing dropdown item">
                    	...
                    	<span class="text"><b>MEU FERALTEN</b></span>
                    	<i class="dropdown icon"></i>
                    	<div class="menu">
                    		<div class="header">Bem vindo,</div>
                    		<a href="/usuario/meu-perfil/" class="item">Anderson Alan Sauberlich</a>
