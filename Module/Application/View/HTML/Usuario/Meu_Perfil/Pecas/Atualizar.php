<?php use Module\Application\View\SRC\Usuario\Meu_Perfil\Pecas\Atualizar as View_Atualizar; ?>
<!DOCTYPE HTML>
<html lang="PT-BR">
<head>
    <?php include_once RAIZ.'/Module/Application/View/HTML/Layout/Head/Default.php'; ?>
    <script type="text/javascript" src="/resources/packages/jquery/jquery.mask-1.14.11.min.js"></script>
    <script type="text/javascript" src="/application/js/usuario/meu_perfil/pecas/atualizar.js"></script>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row-fluid">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <label for="serie" class="lbPanel">Número de Série da Peça:</label>
                                ...
                                <div class="col-sm-3">
                                    <label for="estado_uso" class="lbPanel">Selecione o Estado de Uso da Peça:</label>
                                    <div class="input-group <?php View_Atualizar::Incluir_Classe_Erros("estado_uso"); ?>">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-star-empty"></i></span>
                                        <select id="estado_uso" name="estado_uso" class="form-control form_select">
                                            <option value="0">Selecione</option>
                                            <?php View_Atualizar::Mostrar_Estado_Uso(); ?>
                                        </select>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="input-group <?php View_Atualizar::Incluir_Classe_Erros("descricao"); ?>">
                                    ...
                                    <textarea rows="3" id="descricao" name="descricao" class="form-control" placeholder="Descrição da Peça, detalhes e observações importantes para tornar a peça mais fácil de ser encontrada na pesquisa."><?php View_Atualizar::Manter_Valor("descricao") ?></textarea>
                                </div>
                            </div>
                            <div class="row-fluid">
                            ...
                            <div class="row-fluid">
                                <div class="ui toggle checkbox">
                                	<input name="vip" <?php View_Atualizar::Manter_Valor('vip'); ?> type="checkbox">
