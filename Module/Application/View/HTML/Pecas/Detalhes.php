...
<body>
    ...
    <section class="ui container" role="main">
        ...
        <?php if (View_Detalhes::Verificar_Peca()) { ?>
            ...
            <div class="margem-inferior-minimo"></div>
        <?php } else { ?>
        	<h1 class="ui huge red dividing header">Peça não encontrada</h1>
        	<div class="ui text justified container">
            	<div class="margem-inferior-minimo margem-superior-minimo">
            		<h3 class="ui grey header">
            			Provavelmente o vendedor já vendeu a peça, ou a removeu por algum outro motivo.<br/>
            			Mas não se preocupe, varias peças similares devem estar disponíveis.<br/>
            			Você também pode solicitar orçamentos a todos os nosso vendedores.
            		</h3>
            	</div>
        	</div>
        	<form id="searschform" class="form-horizontal" name="searschform" action="/pecas/resultados/" method="get" role="form">
            	<?php View_Detalhes::Incluir_Menu_Pesquisa(); ?>
        	</form>
            <div class="hidden-xs">
            	<div class="margem-inferior-minimo"></div>
