                ...
                foreach ($categorias as $categoria) {
                    if (isset(self::$form_pesquisa['categoria'])) {
                        if (self::$form_pesquisa['categoria'] == $categoria->get_id()) {
                            echo "<div class=\"col-md-3 col-sm-4 col-xs-12\"><div class=\"ui checked slider checkbox\"><input type=\"radio\" onchange=\"Carregar_Categoria(this)\" checked=\"checked\" id=\"".$categoria->get_id()."\" name=\"categoria\" data-url=\"".$categoria->get_url()."\" value=\"".$categoria->get_id()."\" form=\"searschform\"><label>".$categoria->get_nome()."</label></div></div>";
                        } else {
                            echo "<div class=\"col-md-3 col-sm-4 col-xs-12\"><div class=\"ui slider checkbox\"><input type=\"radio\" onchange=\"Carregar_Categoria(this)\" id=\"".$categoria->get_id()."\" name=\"categoria\" data-url=\"".$categoria->get_url()."\" value=\"".$categoria->get_id()."\" form=\"searschform\"><label>".$categoria->get_nome()."</label></div></div>";
                        }
                    } else {
                        echo "<div class=\"col-md-3 col-sm-4 col-xs-12\"><div class=\"ui slider checkbox\"><input type=\"radio\" onchange=\"Carregar_Categoria(this)\" id=\"".$categoria->get_id()."\" name=\"categoria\" data-url=\"".$categoria->get_url()."\" value=\"".$categoria->get_id()."\" form=\"searschform\"><label>".$categoria->get_nome()."</label></div></div>";
                    }
