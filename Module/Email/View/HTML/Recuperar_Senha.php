<?php use Module\Email\View\SRC\Recuperar_Senha as View_Recuperar_Senha; ?>
<!doctype html>
<html>
  <head>
    <meta name="viewport" content="width=device-width" />
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>Feralten - Recuperar Senha, olá <?= View_Recuperar_Senha::Retornar_Nome_Usuario(); ?></title>
    <style>
      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader">Relaxa, isso acontece o tempo todo! :)</span>
            <table class="main">
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="https://www.feralten.com.br/usuario/recuperar-senha/?codigo=<?= View_Recuperar_Senha::Retornar_Codigo(); ?>" target="_blank">Criar Nova Senha</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
